    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-80 p-6 space-y-4">
        <div className="text-center">
          <img className="mx-auto mb-2 w-[5rem] " src={logo} alt="Anaya Logo" />
        ...
        <button className="w-full bg-purple-600 text-white py-2 rounded-md text-sm font-medium hover:bg-purple-700 transition">
          Get Started
        </button>
